...
<body>
		    ...
		    <span class="navbar-toggler-icon"></span>
		  	...
		  	<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			    <div class="navbar-nav ml-auto">
				    ...
				    <a class="nav-item nav-link active" href="login.php">Ingresar <span class="sr-only">(current)</span></a>
	...
	<div class="container my-5">
		<h3>Ingresar</h3>
		<hr>
		<form action="validacion.php" method="post" class="form bg-dark text-white p-5">
