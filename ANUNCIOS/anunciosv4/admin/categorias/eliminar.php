...
<head>
  	...
  	<title>Admin | Eliminar Categoría</title>
</head>
<body>
	...
	<div class="container my-5">
		...
		if ($resultado = $con->query($query)) {
			echo "<p class='text-success'>Categoría Eliminado</p>";
			echo "<a href='index.php' class='btn btn-primary'>Volver</a>";
		} else {
			echo "<p class='text-danger'>Error al eliminar Categoría</p>";
			echo "<p class='text-info'>!Existen Posts que hacen uso de esta Categoría, para eliminarla deberas eliminar primero todos los Posts que hacen uso de esta Categoría</p>";
			echo "<a href='index.php' class='btn btn-primary'>Volver</a>";
		}
		 ?>
	</div>
