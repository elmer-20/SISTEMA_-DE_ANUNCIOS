...
if ($nombreImagen != null) {
	$query = "UPDATE anuncios SET titulo = '$titulo', imagen = '$destino', fecha = '$fecha', idUsuario = '$idUsuario', contenido = '$contenido', idCategoria = '$idCategoria' WHERE idAnuncio = '$idAnuncio'";
} else {
	$query = "UPDATE anuncios SET titulo = '$titulo', fecha = '$fecha', idUsuario = '$idUsuario', contenido = '$contenido', idCategoria = '$idCategoria' WHERE idAnuncio = '$idAnuncio'";
}
