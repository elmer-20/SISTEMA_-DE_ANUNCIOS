...
$idTipoUsuario = mysqli_real_escape_string($con, $_POST['idTipoUsuario']);
...
<body>
	...
	<div class="container my-5">
		...
		if ($resultado = $con->query($query)) {
			echo "<p class='text-success'>Usuario Agregado</p>";
			echo "<a href='index.php' class='btn btn-primary'>Volver</a>";
		} else {
			echo "<p class='text-danger'>Error al agregar Usuario</p>";
			echo "<a href='index.php' class='btn btn-primary'>Volver</a>";
		}
		 ?>
	</div>
